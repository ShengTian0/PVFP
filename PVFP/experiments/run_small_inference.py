...
def find_latest_model(scale='small'):
...
def run_small_scale_inference(num_sfcs=30):
    """运行小规模网络的纯推理/评估实验"""
    print("\n" + "=" * 80)
    print(" " * 25 + "小规模网络推理/评估实验")
    print("=" * 80)
    ...
    if model_path is None:
        print("[错误] 未找到已保存的模型，请先运行训练脚本生成模型。")
        return None, None
    ...
    print("\n" + "=" * 80)
    print(f"推理/评估总用时: {total_time/60:.2f} 分钟")
    print("=" * 80 + "\n")
...
if __name__ == "__main__":
    run_small_scale_inference(num_sfcs=30)
